...
const FutureLaunchesModule: React.FC = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 relative pb-24">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-[#112922]">Future Launches</h1>
          <p className="text-sm text-gray-500">Manage upcoming and off-plan project portfolios.</p>
        </div>
...
export default FutureLaunchesModule;
